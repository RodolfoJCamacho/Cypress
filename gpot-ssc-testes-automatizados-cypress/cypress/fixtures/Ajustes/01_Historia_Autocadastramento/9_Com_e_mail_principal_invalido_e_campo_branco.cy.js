...
describe('Acesso ao Sistema SEG-ID',() => {
    beforeEach(() => {
        ...
        it('Fluxos e operações Autocadastramento', () =>{                 
            ...
            cy.log ('9 Com e-mail principal invalido e campo em branco validar mensagem de erro')
            ...
            cy.contains('* E-mail:')
            .siblings()
            .filter(elementos.emailAut).type("emailforadepadrao")
            ...
            cy.contains('* E-mail:')
            .siblings()
            .filter(elementos.emailAut).clear()
            cy.get(elementos.concluirButton).eq(1).click()
            cy.get(elementos.msgBoxConfirm).eq(0).click()
            cy.wait(2000)
            cy.get(elementos.msgBoxConfirm).eq(0).click()

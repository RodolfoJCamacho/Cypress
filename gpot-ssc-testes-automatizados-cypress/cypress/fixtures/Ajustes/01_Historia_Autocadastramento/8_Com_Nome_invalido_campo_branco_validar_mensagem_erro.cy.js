    ...
    beforeEach(() => {
       ...
       cy.visit('/');
        ...
        it('Fluxos e operações Autocadastramento', () =>{                 
            ...
            cy.log ('8 Com Nome invalido e campo em branco validar mensagem erro')
            ...
            .siblings()
            .filter(elementos.nomeAut).type("NOMEFORADOPADRAO")
            ...
            .siblings()
            .filter(elementos.telefoneAut).type('1123534646')
             cy.contains('Celular:')
            .siblings()
            ...
            cy.contains('* Nome completo :')
            .siblings()
            .filter(elementos.nomeAut).clear()
            cy.get(elementos.concluirButton).eq(1).click()
            cy.get(elementos.msgBoxConfirm).eq(0).click()
            cy.wait(2000)
            cy.get(elementos.msgBoxConfirm).eq(0).click()

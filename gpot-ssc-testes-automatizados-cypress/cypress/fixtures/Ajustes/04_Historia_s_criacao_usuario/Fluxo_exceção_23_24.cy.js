...
describe('', () => {
    ...
    it('', () => {
        ...
        cy.log('23.Solicitação criação usuário cpf já existente na base de dados SSC')
...
cy.get(elementos.campoInput)
  ...
  .type(Cypress.env('aplicacao'));
                ...
                cy.contains('CPF:')
                    .siblings()
                    .filter(elementos.cpfInput).type(Cypress.env("cpfjaexistente"))
        ...
        cy.log('24.Solicitação criação usuário validar mensagem Unidade_n_ possui vinculo com Papel')
         ...
         cy.get(elementos.botaocarregarfoto).eq(0).click();
               ...
               cy.get(elementos.enviarimagem).eq(1).click()
                ...
                cy.get(elementos.divisao01)
                    ...
                    .filter(elementos.aplicacaoButton).click();
                     cy.contains(Cypress.env('aplicacao01')).click()
                cy.wait(1000)
              ...
              cy.get(elementos.ultimoBotaoTema).click()   
                ...
                cy.contains('Papel:')
                    ...
                    .filter(elementos.unidadeButton).click()
                    cy.wait(1000)
                    cy.get(elementos.campoInput).eq(1).clear()

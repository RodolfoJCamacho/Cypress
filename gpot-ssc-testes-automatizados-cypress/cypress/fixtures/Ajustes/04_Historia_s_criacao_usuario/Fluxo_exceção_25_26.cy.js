...
describe('', () => {
    ...
    it('', () => {
        ...
        cy.log('25.Solicitação criação usuário validar inclusão de diversas permissões na solicitação')
...
cy.get(elementos.campoInput)
  ...
  .type(Cypress.env('aplicacao'));
         ...
         cy.get(elementos.ultimoBotaoTema).click()   
                ...
                cy.wait(1000)
                cy.contains(Cypress.env('unidade03')).click()
                ...
                cy.contains('Papel:')
                    ...
                    cy.wait(1000)
                    cy.get(elementos.listaTabelaP).last().click() 
                    
                    cy.get(elementos.ultimoBotaoTema).last().click()
                   

         cy.contains('Incluir Permissão').click()
                    ...
                    .filter(elementos.unidadeButton).click()
                cy.wait(1000)
                cy.contains(Cypress.env('unidade02')).click()
         ...
         cy.contains('Incluir Permissão').click()
                 cy.contains('Unidade:')
                    ...
                    .filter(elementos.unidadeButton).click()
                cy.wait(1000)
                cy.contains(Cypress.env('unidade04')).eq(0).click()
 ...
 cy.get(elementos.divisao01)
        ...
        cy.log('26.Solicitação criação usuário validar mensagem de erro com os 3 campos email preenchidos com o mesmo email.')
          ...
          cy.contains(Cypress.env('criacaodeusuario')).click();
            ...
            cy.get(elementos.botaocarregarfoto).eq(0).click();
               ...
               cy.get(elementos.enviarimagem).eq(1).click()
                ...
                cy.contains('CPF:')
                    .siblings()
                    .filter(elementos.cpfInput).type(cpf1)

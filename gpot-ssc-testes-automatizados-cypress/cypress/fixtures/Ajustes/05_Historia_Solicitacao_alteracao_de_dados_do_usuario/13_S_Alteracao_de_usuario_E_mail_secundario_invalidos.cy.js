    ...
    beforeEach(() => {
       ...
       cy.visit('/');
        ...
        it('Fluxos e operações Alteração dos dados do usuário', () =>{                 
            ...
            cy.log ('13 Solicitação de alteração de usuário E-mail secundário inválidos')
        ...
        cy.contains('E-mail secundário:')
            .siblings()
            .filter(elementos.emailSecundarioInput).clear().type(Cypress.env('emailgestorerrado'))              

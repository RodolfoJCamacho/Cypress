...
describe('', () => {
    beforeEach(() => {
        ...
        it('14. Vincular Um Papel Usuario Unidade Invalida E Em branco ', () =>{
        ...
        cy.contains('Aplicação/Módulo:')
         ...
         //Campo com os dados Invalidos
         cy.contains('Unidade:') 
         .siblings()
         .children()
         .filter(elementos.campoInput)
         .click()
         .type(Cypress.env('nomesocial'))                                     
         ...
         .siblings()
         .children()
         .filter(elementos.campoInput).clear()
         cy.wait(1000)                             
